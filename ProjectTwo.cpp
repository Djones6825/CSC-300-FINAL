...
// Description : Project Two CPP submission
//============================================================================
...
//Each course contains an Id, Name, and a Vector to hold as many prereqs as the course has
...
/*
Each node in the Binary Search Tree contains the course info and left and right children
...
//Deconstruct the Binary Search Tree by passing the root to the function that recursively deletes each node

CourseBST::~CourseBST() {
	DeleteRecursive(root);
}

//Delete the Binary Search Tree nodes recursively this is used by the deconstructor
...
/*
Utilizes the public Insert method determines and sets correct alphanumeric location
and if the current child is a nullptr it adds the node to the Binary Search Tree,
else it keeps traversing Binary Search Tree until a nullptr is found
*/
	...
	try {
		...
		if (courseFile.is_open()) {
			while (!courseFile.eof()) {
				...
				// Load the separated values into a course, and insert into Binary Search Tree and close file
				Course course;
...
int main(int argc, char* argv[]) {
	...
	while (userChoice != 9) {
		...
		switch (userChoice) {
			...
			// get file path name and load courses into Binary Search Tree
